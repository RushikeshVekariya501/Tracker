...
public class TransactionForEachGroupAdapter extends RecyclerView.Adapter<TransactionForEachGroupAdapter.ViewHolder> {
    ...
    private TransactionForEachGroupAdapter.ViewHolder viewHolder;
    private NavController navController;

    public TransactionForEachGroupAdapter(Context mContext, Activity mActivity, ArrayList<TransactionModel.DataBean> groupArrayList) {
    ...
    @Override
    public TransactionForEachGroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        view = LayoutInflater.from(mActivity).inflate(R.layout.raw_transaction_for_each_group, parent, false);

        view.setTag(viewHolder);
        viewHolder = new TransactionForEachGroupAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final TransactionForEachGroupAdapter.ViewHolder holder, final int position) {
